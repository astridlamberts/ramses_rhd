...
int main(int argc,char *argv[])
{
  ...
  CC=     3.0;        /* halo concentration      */
  V200=   145.0;      /* circular velocity v_200 (in km/sec) */
  LAMBDA= 0.031;      /* spin parameter          */
  MD=     0.04;        /* disk mass fraction      */
  MB=     0.008;       /* bulge mass fraction     */
  ...
  N_DISK=  10000;       /* desired number of collisionless particles in disk */
