module hydro_parameters
  ...
  real(dp),dimension(1:100)::t_bound=0.0d0
  ...
  real(dp),dimension(1:100)::t_region=0.
  ...
  real(dp)::epsilon_diff=1d-8
  logical::dt_control=.false.
  real(dp),dimension(1:10)::dtexpl_params=1d10 ! Conduction time step behaviour
  real(dp),dimension(1:10)::chi_params=1.0     ! Conduction coefficient's parameters
  real(dp),dimension(1:10)::omega_params=1.0   ! Relaxation coefficient's parameters
  character(LEN=50)::chi_type='analytic'       ! Conduction coefficient's type
  character(LEN=50)::omega_type='analytic'     ! Relaxation coefficient's type
  real(dp)::mass_input
