subroutine read_hydro_params(nml_ok)
  ...
  namelist/init_params/filetype,initfile,nregion,region_type &
       ...
       & ,d_region,u_region,v_region,w_region,p_region,t_region
  namelist/hydro_params/gamma,courant_factor,smallr,smallc,c_star &
       ...
       & ,dt_control,dtexpl_params,chi_params,chi_type &
       & ,omega_params,omega_type,epsilon_diff,mass_input
  namelist/refine_params/x_refine,y_refine,z_refine,r_refine,a_refine,b_refine,exp_refine &
       & ,m_refine,mass_sph,err_grad_d,err_grad_p,err_grad_u,err_grad_t,floor_d,floor_u,floor_p,floor_t &
  ...
  namelist/boundary_params/nboundary,bound_type &
       ...
       & ,d_bound,u_bound,v_bound,w_bound,p_bound,t_bound
  ...
  !--------------------------------------------------
  ! If diffusion, enable two more arrays
  !--------------------------------------------------
  if(diffusion==.true.) pressure_fix=.true.
  ...
  do i=1,nboundary
     ...
     boundary_var(i,ndim+3)=d_bound(i)*t_bound(i)
  end do
