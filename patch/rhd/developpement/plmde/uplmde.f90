     ...
     do j = jlo, jhi
        do i = ilo, ihi
           do l = 1, ngrid
              ...
              ! check for superluminous velocities
...
!              if (nstep .eq. 380) then
!                 if ((l=


              if ((nstep > 380) .and. (nstep <380)) then
!                 if (( l > 150) .and. (l < 175)) then
                    if ((u< 0).and. (u<-1.0e-2)) then
                       write(*,*),r,u,v,p,'central',l
                    endif
                    if ((qm(l,i,j,k,2,1)< 0).and. (qm(l,i,j,k,2,1)<-1.0e-2)) then
                       write(*,*),l,qm(l,i,j,k,:,1),'gauche'
                    endif

                    if ((qp(l,i,j,k,2,1)< 0).and. (qp(l,i,j,k,2,1)<-1.0e-2)) then
                       write(*,*),l,qp(l,i,j,k,:,1),'droite'
                    endif

                    if ((qm(l,i,j,k,2,2)< 0).and. (qm(l,i,j,k,2,2)<-1.0e-2)) then
                       write(*,*),l,qm(l,i,j,k,:,2),'bas'
                    endif

                    if ((qp(l,i,j,k,2,2)< 0).and. (qp(l,i,j,k,2,2)<-1.0e-2)) then
                       write(*,*),l,qp(l,i,j,k,:,2),'haut'
                    endif
...
!                 write(*,*),qm(l,i,j,k,1,2), r,qp(l,i,j,k,1,2), 'r id'
!                 endif
!              if ((qm(l,i,j,k,2,2) .ne. u) .or. (qp(l,i,j,k,2,2) .ne. u)) then
!                 write(*,*),qm(l,i,j,k,2,2), u,qp(l,i,j,k,2,2), 'u id'
!                 endif
!              if ((qm(l,i,j,k,3,2) .ne. v) .or. (qp(l,i,j,k,3,2) .ne. v)) then
!                 write(*,*),qm(l,i,j,k,3,2), v,qp(l,i,j,k,3,2), 'v id'
!                 endif
!              if ((qm(l,i,j,k,4,2) .ne. w) .or. (qp(l,i,j,k,4,2) .ne. w)) then
!                 write(*,*),qm(l,i,j,k,4,2), w,qp(l,i,j,k,4,2), 'w id'
!                 endif
!              if ((qm(l,i,j,k,5,2) .ne. p) .or. (qp(l,i,j,k,5,2) .ne. p)) then
!                write(*,*),qm(l,i,j,k,5,2), p,qp(l,i,j,k,5,2), 'r id'
!                 endif
