recursive subroutine amr_step(ilevel,icount)
  ...
  if(ilevel==levelmin)then
     !----------------------------------------------------
     ! Feedback from supernovae blast waves using the grid
     !----------------------------------------------------
     if(star.and.eta_sn>0.and.ndebris==0)call make_sn_grid
  ...
  if(poisson)then
     ...
     if(hydro)then
        ...
        ! Feedback from supernovae blast waves using debris particles
        if(star.and.eta_sn>0.and.ndebris>0)call feedback(ilevel)
