           ...
           if(ncache>0)then
              ...
              do ind=1,twotondim
                 ...
                 do i=1,ncache
                    ...
                    uold(ind_grid(i)+iskip,2)=(rr(i)+gamma2/(gamma2-1)*pp(i))*lor**2*vx(i)
                    uold(ind_grid(i)+iskip,3)=(rr(i)+gamma2/(gamma2-1)*pp(i))*lor**2*vy(i)
                    uold(ind_grid(i)+iskip,4)=(rr(i)+gamma2/(gamma2-1)*pp(i))*lor**2*vz(i)
                    uold(ind_grid(i)+iskip,5)=(rr(i)+gamma2/(gamma2-1)*pp(i))*lor**2-pp(i)
                    if (nvar2>5) then
                       uold(ind_grid(i)+iskip,ivar)= uold(ind_grid(i)+iskip,ivar)*uold(ind_grid(i)+iskip,1)
                    endif
                 end do
              end do
