...
subroutine trace1d(q,dq,qm,qp,dx,dt,ngrid)
  ...
  use hydro_parameters
  use const
!  use variables , only : x (à voir)
!  use hydro_commons ( à voir)
  implicit none
...
!              write(*,*),qp(l,i,j,k,ir,1),l,i,j,k,'l'
!              write(*,*),qm(l,i,j,k,ir,1),l,i,j,k,'r'
           end do
        end do
     end do
  end do
...
!             if (t >0.44) then 
!                write(*,*),q(l,i,j,k,1),uin(l,i,j,k,1),q(l,i,j,k,3),uin(l,i,j,k,3),l,i
!             endif
        end do
