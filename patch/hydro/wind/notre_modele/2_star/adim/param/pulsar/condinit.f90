...
open (unit=42,file="param_run.dat")
write(42,*),a,period,'a,period'
write(42,*),epsilon_star1,epsilon_star2,'epsilon_star1,2'
write(42,*),r0_1,r0_2,'r01,r02'
write(42,*),M_dot1,M_dot2,'Mdot1,Mdot2'
write(42,*),v_inf1,v_inf2,'v_inf1,vinf2'
write(42,*),Mach_1,Mach_2,'Mach1,Mach2'
write(42,*),R_rho,R_P,'R_rho,R_p' 
...
!positions of the stars
  ...
  x02   = 0.5d0*boxlen+1.0d0 !+(a/2.0d0)
  y02   = 0.5d0*boxlen
  z02   = 0.5d0*boxlen
...
!values for r=a
 ...
 ! write(*,*),t,period,cos(2.0D0*3.1415/period*t),'t,T,cos'
  ...
  x02   = 0.5d0*boxlen+cos(2.0D0*3.1415/period *t) !+(a/2.0d0)
  y02   = 0.5d0*boxlen+sin(2.0d0*3.1415/period *t)
  z02   = 0.5d0*boxlen
    ...
    ! write(*,*),delta_x,'reset_mask'
     call condinit2_pulsar(xx,u_mask,dx_loc,ngrid,x02,y02,z02,r0_2,a,M_dot2,v_inf2,Mach_2,delta_x)
         ...
         do i=1,ngrid
           ...
           ! write(*,*),xcen2,ycen2,rc2,'xcen2,ycen2,rc2'
#if NDIM ==3
            zcen1=xx(i,3)-z01
