...
call read_namelist(epsilon_star1,epsilon_star2,r0_1,r0_2,M_dot1,M_dot2,v_inf1,v_inf2&
 ...
 !positions of the stars
  x01   = 0.5d0*boxlen-(3.0d0*a/4.0d0)
  y01   = 0.5d0*boxlen
  z01   = 0.5d0*boxlen
  
  x02   = 0.5d0*boxlen+(a/4.0d0)
  y02   = 0.5d0*boxlen
  z02   = 0.5d0*boxlen

! compute v1,rho1,P1 , variables at 'a'
 ...
 rho_2 = M_dot2/(2.0d0*pi*a*v_2)
  ...
  P_1 = v_2**2* rho_1/(Mach_1**2*gamma)
       ...
       do j=1,n
          do k=1,n
             integral =integral +(delta_x/n)**ndim*density((xx+(i-5.0d0-0.5d0)*delta_x/n)&
                  ...
                  ,_dot,r0,a,v_inf,epsilon_star,beta) 
          end do
       end do
   end do
#endif
