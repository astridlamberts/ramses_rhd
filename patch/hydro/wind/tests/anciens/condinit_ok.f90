...
!            write(*,*),uold(ind_cell(i),4),i,'star'
!         endif            
            else if (type1=='puls')then
...
!write(*,*),uold(ind_cell,1),xc,yc,rc
...
!write(*,*),fs*f(vinf,a,rstar,rho,v,rc)*vflu*dtnew(ilevel)
!      if (uold(ind_cell,4).lt. 0.0d0)then
!         write(*,*),uold(ind_cell,4),xc,yc,rc,'star',i,u_mask(i,1),uold(ind_cell,1)
!         endif
...
!  c1 = f1*f(vinf1,a,rstar1,rho1,v1,rc1)*vflu*dtnew(ilevel)
!  c2 = f2*f(vinf2,a,rstar2,rho2,v2,rc2)*vflu*dtnew(ilevel)
