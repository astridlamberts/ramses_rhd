  ...
  do ind=1,twotondim
   ...
   ! Gather cell centre positions
    ...
    ! Call reset of the mask routine, changes uold in the mask
     call condinit2(xx,u_mask,dx_loc,ngrid,coef_x01,coef_y01,coef_z01,coef_r01,rho_01,P_01,v_inf1,alpha1)
     call condinit2(xx,u_mask,dx_loc,ngrid,coef_x02,coef_y02,coef_z02,coef_r02,rho_02,P_02,v_inf2,alpha2)
...
subroutine condinit2(x,u,dx,nn,coef_x0,coef_y0,coef_z0,coef_r0,rho_0,P_0,v_inf,alpha)
  use amr_parameters
  use hydro_parameters
  use poisson_parameters
