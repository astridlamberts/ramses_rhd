...
!run parameters
  ...
  epsilon_star1= 0.03/a!0.046d0/a!normalement 0.046
  epsilon_star2= 0.03/a!0.046d0/a
  r0_1= 0.05/a!0.092d0/a  !normalement 0.092
  r0_2= 0.05/a!0.092d0/a
...
!  real(dp)::gamma = 5.d0/3.d0  ! a voir 
  ...
  epsilon_star2= 0.03/a!!0.046d0/a
  r0_1= 0.05/a!!0.092d0/a  !normalement 0.092/a
  r0_2= 0.05/a!!0.092d0/a
  M_dot1= 1.0d0   ! unit : 10**(-8) Msun/yr
  M_dot2= 1.0d0
...
! computing the integral in the middle of the slice, be careful with size of the box!
         integral =integral +delta_x/n*delta_x/n*velocity_x((xx+(i-5.0d0-0.5d0)*delta_x/n)&
              ,(yy+(j-5.0d0-0.5d0)*delta_x/n),xx,v_inf,epsilon_star,beta)
      end do
   end do
#endif
...
! computing the integral in the middle of the slice, be careful with size of the box!
         integral =integral +delta_x/n*delta_x/n*velocity_y((xx+(i-5.0d0-0.5d0)*delta_x/n)&
              ,(yy+(j-5.0d0-0.5d0)*delta_x/n),zz,v_inf,epsilon_star,beta)
       end do
    end do
#endif
...
function velocity_x(x,y,z,v_inf,epsilon_star,beta) ! function which returns the velocity for a given position
implicit none
real(kind=8):: velocity_x
real(kind=8)::x,y,z
real(kind=8)::epsilon_star 
...
r=sqrt(x**2+y**2+z**2)
velocity_x=v_inf*(x/r)*max((1.0d0-epsilon_star/r)**beta,0.d0)


return
end function velocity_x

function velocity_y(x,y,z,v_inf,epsilon_star,beta) ! function which returns the velocity for a given position
implicit none
real(kind=8):: velocity_y
real(kind=8)::x,y,z
real(kind=8)::epsilon_star 
...
r=sqrt(x**2+y**2+z**2)
velocity_y=v_inf*(y/r)*max((1.0d0-epsilon_star/r)**beta,0.d0)

return
end function velocity_y

function velocity_z(x,y,z,v_inf,epsilon_star,beta) ! function which returns the velocity for a given position
implicit none
real(kind=8):: velocity_z
real(kind=8)::x,y,z
real(kind=8)::epsilon_star 
real(kind=8)::v_inf   
real(kind=8)::r ! distance from center of the mask
real(kind=8)::beta  ! a ameliorer


r=sqrt(x**2+y**2+z**2)
velocity_z=v_inf*(z/r)*max((1.0d0-epsilon_star/r)**beta,0.d0)
