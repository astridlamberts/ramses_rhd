     ...
     do j = jlo, jhi
        do i = ilo, ihi
           do l = 1, ngrid
              ...
              spx = half*dtdy*(-v*dpy - (dvy)*r*csq  )

              sry = half*dtdx*(-u*drx - (dux)*r      )
              suy = half*dtdx*(-u*dux - (dpx)/r      )
              svy = half*dtdx*(-u*dvx                )
              spy = half*dtdx*(-u*dpx - (dux)*r*csq  )
     ...
     do j = jlo, jhi
        do i = ilo, ihi
           do l = 1, ngrid
              ...
              spx = half*dtdx*(-v*dpy-w*dpz - (dvy+dwz)*r*csq  )
              ...
              spy = half*dtdx*(-u*dpx-w*dpz - (dux+dwz)*r*csq  )
              ...
              spz = half*dtdx*(-v*dpy-u*dpx - (dvy+dux)*r*csq  )
