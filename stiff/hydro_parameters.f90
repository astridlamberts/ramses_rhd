module hydro_parameters
  ...
  real(dp),dimension(1:100)::gamma_bound=0.0d0
  real(dp),dimension(1:100)::pinf_bound=0.0d0
  ...
  real(dp),dimension(1:100)::gamma_region=0.
  real(dp),dimension(1:100)::pinf_region=0.
