; $Id: gaussfit.pro,v 1.11 2000/01/21 00:29:06 scottm Exp $
;
...
Function Gaussfit_mrk, x, y, a, NTERMS=nt, ESTIMATES = est, sigmafit=sigmafit
;+
; NAME:
;	GAUSSFIT
;
...
return,curvefit(x,y,replicate(1.,n),a,sigmafit, $
