...
subroutine trace1d(q,dq,qm,qp,dx,dt,ngrid)
  ...
  real(dp)::dtdx
  real(dp)::r, u, p, e, a
  real(dp)::drx, dux, dpx, dex, dax
  real(dp)::sr0, su0, sp0, se0, sa0
...
subroutine trace2d(q,dq,qm,qp,dx,dy,dt,ngrid)
  ...
  real(dp)::dtdx, dtdy
  real(dp)::r, u, v, p, e, a
  real(dp)::drx, dux, dvx, dpx, dex, dax
  real(dp)::dry, duy, dvy, dpy, dey, day
  real(dp)::sr0, su0, sv0, sp0, se0, sa0
     ...
     do j = jlo, jhi
        do i = ilo, ihi
           do l = 1, ngrid
              ...
              se0 = -u*dex-v*dey - (dux+dvy)*gamma*e
...
subroutine trace3d(q,dq,qm,qp,dx,dy,dz,dt,ngrid)
  ...
  real(dp)::r, u, v, w, p, e, a
  real(dp)::drx, dux, dvx, dwx, dpx, dex, dax
  real(dp)::dry, duy, dvy, dwy, dpy, dey, day
  real(dp)::drz, duz, dvz, dwz, dpz, dez, daz
  real(dp)::sr0, su0, sv0, sw0, sp0, se0, sa0
     ...
     do j = jlo, jhi
        do i = ilo, ihi
           do l = 1, ngrid
              ...
              se0 = -u*dex-v*dey-w*dez - (dux+dvy+dwz)*gamma*e
...
#if NDIM>1
           do l = 1, ngrid
              qleft (l,5) = qm(l,i,j,k,lt1,xdim)
              qright(l,5) = qp(l,i,j,k,lt1,xdim)
           end do
#endif
           ! Tangential velocity 2
#if NDIM>2
           do l = 1, ngrid
              qleft (l,6) = qm(l,i,j,k,lt2,xdim)
              qright(l,6) = qp(l,i,j,k,lt2,xdim)
           end do
#endif           
