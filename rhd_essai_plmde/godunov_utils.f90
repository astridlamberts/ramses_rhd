...
!sound speed
 ...
 ! 5.A850356174335698E-003  0.102568850782662       0.994725472375672
 ! 0.103502805114948      Ql
 ! 5.866786853054901E-003  0.101464412106664       0.994823620629654
 ! 0.103989167259906      Qr
...
!  if (((nstep .eq. 396) .or. (nstep .eq. 395)) .and.   ((qleft(1)  .eq. 5.850356174335698E-003) .or. (qleft(1)  .eq. 5.866786853054901E-003) .or. (qright(1) .eq.   5.866786853054901E-003) .or. (qright(1) .eq.   5.850356174335698E-003))) then

!     write(*,*),''
!     write(*,*),qleft,'left',lorr
!     write(*,*),qright,'right' ,lorl
!     write(*,*),fgdnv,'godunov'
!     write(*,*),''
!  endif
