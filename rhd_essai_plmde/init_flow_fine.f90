     ...
     do igrid=1,ncache,nvector
        ...
        do ind=1,twotondim
           ...
           do i=1,ngrid
              ...
              uold(ind_cell(i),2)=(rr+gamma/(gamma-1)*pp)*lor**2*vx
              uold(ind_cell(i),3)=(rr+gamma/(gamma-1)*pp)*lor**2*vy
              uold(ind_cell(i),4)=(rr+gamma/(gamma-1)*pp)*lor**2*vz
              uold(ind_cell(i),5)=(rr+gamma/(gamma-1)*pp)*lor**2-pp
              !Passive scalars
              do ivar=6,nvar
