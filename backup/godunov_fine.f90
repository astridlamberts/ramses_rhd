...
!              end if
   ...
   do idim=1,ndim
     ...
     do i2=i2min,i2max
        ...
        do i=1,ncache
          ...
          enddo
          if ((nstep .ge. 389) .and. (nstep .lt. 392) .and. (idim .eq. 1) .and. & 
               (ind_cell(i) .eq. 143980) .and. (i3 .eq. 2) .and. (j3 .eq.1) .and. (k3 .eq. 1) &
               .and. (i .eq. 161))  then
 ...
 !                write(*,*),var5,'E avant update',ind_cell(i)
  ...
  !               write(*,*),unew(ind_cell(i),1),'D apres update',ind_cell(i)
...
!                 write(*,*),sqrt(unew(ind_cell(i),2)**2+unew(ind_cell(i),3)**2),'M>E apres update',ind_cell(i),i
